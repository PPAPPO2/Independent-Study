...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        tables = [
            ...
            (P_Season_teams_Performance_24_25,'P_Season_teams_Performance_24_25.json')
        ]
