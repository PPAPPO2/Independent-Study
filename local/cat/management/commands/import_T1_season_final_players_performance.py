...
from cat.models import T1_Season_Players_Final_Performance_23_24, T1_Season_Players_Final_Performance_22_23
import json
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # 爬取JSON檔案的URL
        url = 'https://api.t1league.basketball/season/4/stages/11/rosters'
        ...
        T1_Season_Players_Final_Performance_22_23.objects.all().delete()
        ...
        for roster in data:
            ...
            T1_Season_Players_Final_Performance_22_23.objects.create(
