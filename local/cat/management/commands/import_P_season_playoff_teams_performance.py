...
from cat.models import  P_Season_Teams_Playoff_Performance_22_23,P_Season_Teams_Playoff_Performance_23_24
import pandas as pd
import json
import re
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for FINAL_data in temp:
            ...
            P_Season_Teams_Playoff_Performance_23_24.objects.create(
