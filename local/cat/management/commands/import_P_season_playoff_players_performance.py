...
from cat.models import P_Season_Players_Palyoff_Performance_20_21, P_Season_Players_Palyoff_Performance_21_22, P_Season_Players_Palyoff_Performance_22_23, P_Season_Players_Playoff_Performance_23_24
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # 清空現有數據
        P_Season_Players_Playoff_Performance_23_24.objects.all().delete()
        ...
        def get_time(time_str):
            try:
                ...
                if seconds == 60:
                    minutes += 1
                    seconds = 0
                temp = timedelta(minutes=minutes, seconds=seconds)
            except ValueError:
                try:
                    ...
                    if seconds == 60:
                        minutes += 1
                        seconds = 0
                    temp = timedelta(hours=hours, minutes=minutes, seconds=seconds)
                except ValueError:
...
# 遍歷JSON數據
        for rosters in temp:
            ...
            P_Season_Players_Playoff_Performance_23_24.objects.create(
                player=rosters["球員"],
                jersey=rosters["背號"],
                team=rosters["球隊"],
