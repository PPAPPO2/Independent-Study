...
from cat.models import T1_Season_Teams_Final_Performance_22_23, T1_Season_Teams_Final_Performance_23_24
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # 爬取JSON檔案的URL
        url = 'https://api.t1league.basketball/season/4/stages/11/teams'
        ...
        T1_Season_Teams_Final_Performance_22_23.objects.all().delete()
        ...
        for team in data:
            ...
            T1_Season_Teams_Final_Performance_22_23.objects.create(
