# Generated by Django 4.2.11 on 2024-05-28 07:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cat', '0023_season_players_performance_20_21_all_goals_made_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='T1_Season_teams_Performance_22_23',
            fields=[
        ...
        migrations.CreateModel(
            name='T1_Season_teams_Performance_23_24',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('team', models.CharField(max_length=10)),
                ('gp', models.CharField(max_length=10)),
